const context = {
    ...
    instruments: [
      ...
      {
        image: 'https://images.unsplash.com/photo-1547927168-17021e7ef8c3?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60',
        name: 'Trombone',
        description: 'A wonderful brass instrument for those all so familar jazz tunes.',
        price: '$500.00'
      }
    ]
  };
